...
export default function RiseUpListControls({ flow, onFlowChange, selectedCategories, onSelectedCategoriesChange, categories, sortBy, onSortChange }) {
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <CategoryMultiSelect categories={categories} selected={selectedCategories} onChange={onSelectedCategoriesChange} />
